...
CREATE TABLE IF NOT EXISTS `#__bazi_charts` (
  ...
  `user_id` int unsigned NOT NULL DEFAULT 0 COMMENT 'FK to #__users.id, 0 for guest calculations (should not exist)',
...
CREATE TABLE IF NOT EXISTS `#__bazi_gpt_logs` (
  ...
  `model` varchar(50) NOT NULL COMMENT 'Model used (e.g., gpt-4)',
